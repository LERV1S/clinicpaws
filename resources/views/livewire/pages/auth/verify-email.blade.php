...
<div>
    ...
    <div class="mt-4 flex items-center justify-between">
        ...
        <button class="ms-3 bg-gray-900 text-white hover:bg-gray-400 hover:text-black border border-black px-4 py-2 rounded-md" wire:loading.attr="disabled" wire:click="sendVerification">
            {{ __('Resend Verification Email') }}
        </button>
