    ...
    public function up(): void
{
    Schema::create('medical_records', function (Blueprint $table) {
        ...
        $table->text('x_rays')->nullable(); // Rayos X
        $table->text('ultrasound')->nullable(); // Ultrasonido
        $table->text('ct_scans')->nullable(); // Tomografía computarizada
        $table->text('biopsies')->nullable(); // Biopsias
