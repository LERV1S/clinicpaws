...
# Guardar el codificador animal_label_encoder para su uso posterior
...
# Rellenar valores nulos en las columnas de síntomas
...
preprocessor = ColumnTransformer(
    transformers=[('symptom1', TfidfVectorizer(), 'symptoms1'),
...
# Guardar también el codificador 'dangerous_label_encoder' si es necesario
with open('ml_service/dangerous_label_encoder.pkl', 'wb') as file:
    pickle.dump(dangerous_label_encoder, file)

print("Modelo guardado exitosamente en 'modelo.pkl'.")
print("Codificador guardado exitosamente en 'animal_label_encoder.pkl'.")
